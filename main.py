...
async def send_startup_message(client):
    ...
    niyam_status = niyam.status_line()
    text = (
        "🟢 **Bot is Now Online!**\n"
        "━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
    ...
    # Rage mode culprit announcement (once, on first startup after rage)
    announcement = niyam.pop_culprit_announcement()
    if announcement:
        for owner_id in config.OWNER_ID:
            try:
                await client.send_message(owner_id, announcement)
            except Exception:
                pass
